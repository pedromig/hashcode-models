...
class Solution:
    ...
    def copy(self: Solution):
      return Solution(self.problem, copy.deepcopy(self.books), self.quota.copy(),
        copy.deepcopy(self.used), self.libraries.copy(), self.closed.copy(), self.open,
    ...
    def add(self: Solution, c: Component) -> None: 
      ...
      print(self.ub_kp, self.ub_full, self.ub_lim)
